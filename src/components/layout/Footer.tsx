        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              The ultimate community for robot vacuum enthusiasts. All brands, all models — reviews, tips, deals, and troubleshooting.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-muted-foreground">
              <li><Link href="/f/reviews" className="hover:text-foreground">Reviews</Link></li>
              <li><Link href="/f/discussion" className="hover:text-foreground">Discussion</Link></li>
              <li><Link href="/f/troubleshooting" className="hover:text-foreground">Troubleshooting</Link></li>
              <li><Link href="/f/deals" className="hover:text-foreground">Deals & Discounts</Link></li>
              <li><Link href="/f/brand-forums" className="hover:text-foreground">Brand Forums</Link></li>
            </ul>
          </div>
